...
! function(t, i) {
    ...
    return e.compatOptions.fitWidth = "isFitWidth", e.prototype._resetLayout = function() {
        ...
        for (var h = this._getColGroup(o), s = Math.min.apply(Math, h), n = h.indexOf(s), r = {
                ...
                y: s
            }, a = s + t.size.outerHeight, u = this.cols + 1 - h.length, l = 0; u > l; l++) this.colYs[n + l] = a;
        return r
...
! function(t, e) {
    ...
    return o._resetLayout = function() {
        ...
        for (var r = this._getRowGroup(o), s = Math.min.apply(Math, r), h = r.indexOf(s), a = {
                x: s,
                y: this.rowHeight * h
            }, n = s + t.size.outerWidth, u = this.rows + 1 - r.length, g = 0; u > g; g++) this.rowXs[h + g] = n;
        return a
...
! function(t, i) {
    ...
    g._create = function() {
        ...
        if (!(0 !== s && s > e)) {
            ...
            h || (this.shiftTargetKeys.push(r), this.shiftTargets.push({
                x: t,
                y: i
            }))
        }
...
ID.modules["commercial-license-agreement"] = function(e) {
    ...
    t(o.querySelector(".button--developer")), o.addEventListener("click", function(e) {
    ...
    function(t, e, o) {
        var i = {
            ...
            checkBrowser: function() {
                ...
                a.style.cssText = "  -moz-transform:" + s + "; -ms-transform:" + s + "; -o-transform:" + s + "; -webkit-transform:" + s + "; transform:" + s, t = /translate3d\(0px, 0px, 0px\)/g, e = a.style.cssText.match(t), o = null !== e && 0 !== e.length, i = "ontouchstart" in window || window.navigator.msMaxTouchPoints, n.browser = {
                    support3d: o,
                    isTouch: i
                }
            },
